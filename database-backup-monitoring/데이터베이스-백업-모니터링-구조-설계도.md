> 문서 상태: 과거 설계가 일부 포함되어 있다. 최신 기준은 DB `172.16.43.160`, Grafana host `grafana.team.snow.internal`, HAProxy/Keepalived VIP `172.16.42.99`이다.
>
> 이 문서의 `db.onprem.local`, `grafana.onprem.local`, MetalLB `172.16.41.112` 설명은 최신 구현 기준과 다를 수 있다.
