> 문서 상태: 과거 후보안이다. 최종 채택 기준이 아니며, 최신 기준은 [current-architecture-summary.md](./current-architecture-summary.md)를 우선한다.
>
> 이 문서의 AWS Front Door/EC2 HAProxy 중심 구조는 최종 운영 구조로 채택되지 않았다.
